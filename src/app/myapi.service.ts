...
export class MyapiService {
  ...
  getAllProducts()
  {
    return this.httpClient.get(this.baseURLproduct+"/products");
  }

  serachProductById(productid:number)
  {
    return this.httpClient.get(this.baseURLproduct+"/products/"+productid);
  }
  // serachProductByName(pname:string)
  // {
  //   return this.httpClient.get(this.baseURLproduct+"/products/productname/"+pname);
  // }
 ...
 baseURLproduct:string="http://localhost:9797/UserDetailsRest/api";
 addProducts(finProduct:Product){
   return this.httpClient.post(this.baseURLproduct+"/products",finProduct);

 }
//  sendMail(maildetail:MailDetails){

//   return this.httpClient.get(this.baseUrlRP+"/sendMail",maildetail);
//  }
